...
//Loads the players assets
void Player::load()
{
	statusFont = al_load_font("status.ttf", 12, 0); //Font for status bar
...
{
	al_draw_line(0, 520, 1589, 520, al_map_rgb(255, 255, 0), 5); //Line to separate status bar with game window
	...
	//Draw rupee quantity
	al_draw_bitmap_region(dude, 412, 339, 12, 24, 695, 545, 0);
	al_draw_textf(statusFont, al_map_rgb(255, 255, 255), 705, 545, 0, ": X%d", rupees);
